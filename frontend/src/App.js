...
const App = () => {
  ...
  return (
    <div className="app">
      ...
      <main className={`main-content${location.pathname === '/' ? ' home-active' : ''}${location.pathname.startsWith('/admin') ? ' admin-active' : ''}${location.pathname.startsWith('/products/') ? ' product-detail-active' : ''}`}>
